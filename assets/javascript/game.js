...
document.onkeyup = function wordGuess(event) {
    ...
    for (var i = 0; i < beatlesLetterArray.length; i++) {

        if (userGuess !== beatlesLetterArray[i]) {
    ...
    else if (document.getElementById("blanks").innerHTML === "B e a _ _ e _") {
    
        if (userGuess === "t" || userGuess === "T") {
